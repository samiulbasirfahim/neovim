		...
		config = function()
			...
			code_runner.setup({
				...
				filetype = {
					...
					c = "cd $dir && mkdir -p .bin && cd .bin && clang --debug ../$fileName -o $fileNameWithoutExt && ./$fileNameWithoutExt",
					cpp = "cd $dir && mkdir -p .bin && cd .bin && clang++ --debug ../$fileName -o $fileNameWithoutExt && ./$fileNameWithoutExt",
				},
				project = {},
			})
		end,
